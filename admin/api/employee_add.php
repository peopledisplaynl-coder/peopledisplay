...
try {
    ...
    // 🔍 DEBUG: Log de volledige URL
    $fullURL = $scriptURL . '?action=addemployee';
    error_log("=== EMPLOYEE ADD REQUEST ===");
    ...
    $ch = curl_init($scriptURL . '?action=addemployee');
